...
conn = mysql.connector.connect(user='root', password='root@123', host='127.0.0.1', database="phonepe")
...
SELECT = option_menu(
    ...
    styles={"container": {"padding": "0!important", "background-color": "white","size":"cover", "width": "100%"},
        ...
        "nav-link": {"font-size": "20px", "text-align": "center", "margin": "10px", "--hover-color": "#6F36AD"},
...
if SELECT == "Home":
    col1,col2, = st.columns(2)
    col1.image(Image.open("/Users/prashanthk/Desktop/Phonepe_Pulse_Data_Visualization-main/phonepe.png"),width = 500)
    with col1:
    ...
    with col2:
        st.video("/Users/prashanthk/Desktop/Phonepe_Pulse_Data_Visualization-main/upi.mp4")
    ...
    Data_Aggregated_Transaction_df= pd.read_csv(r'/Users/prashanthk/Desktop/Phonepe_Pulse_Data_Visualization-main/myfolder/Data_Aggregated_Transaction_Table.csv')
    Data_Aggregated_User_Summary_df= pd.read_csv(r'/Users/prashanthk/Desktop/Phonepe_Pulse_Data_Visualization-main/myfolder/Data_Aggregated_User_Summary_Table.csv')
    Data_Aggregated_User_df= pd.read_csv(r'/Users/prashanthk/Desktop/Phonepe_Pulse_Data_Visualization-main/myfolder/Data_Aggregated_User_Table.csv')
    Scatter_Geo_Dataset =  pd.read_csv(r'/Users/prashanthk/Desktop/Phonepe_Pulse_Data_Visualization-main/myfolder/Data_Map_Districts_Longitude_Latitude.csv')
    Coropleth_Dataset =  pd.read_csv(r'/Users/prashanthk/Desktop/Phonepe_Pulse_Data_Visualization-main/myfolder/Data_Map_IndiaStates_TU.csv')
    Data_Map_Transaction_df = pd.read_csv(r'/Users/prashanthk/Desktop/Phonepe_Pulse_Data_Visualization-main/myfolder/Data_Map_Transaction_Table.csv')
    Data_Map_User_Table= pd.read_csv(r'/Users/prashanthk/Desktop/Phonepe_Pulse_Data_Visualization-main/myfolder/Data_Map_User_Table.csv')
    Indian_States= pd.read_csv(r'/Users/prashanthk/Desktop/Phonepe_Pulse_Data_Visualization-main/myfolder/Longitude_Latitude_State_Table.csv')
...
if SELECT == "About":
    col1,col2 = st.columns(2)
    with col1:
        st.video("/Users/prashanthk/Desktop/Phonepe_Pulse_Data_Visualization-main/myfolder/pulse-video.mp4")
    with col2:
        st.image(Image.open("/Users/prashanthk/Desktop/Phonepe_Pulse_Data_Visualization-main/myfolder/PhonePe_Logo.jpg"),width = 1000)
        st.write("---")
    ...
    with col1:
        ...
        st.image(Image.open("/Users/prashanthk/Desktop/Phonepe_Pulse_Data_Visualization-main/myfolder/top.jpeg"),width = 400)
        with open("/Users/prashanthk/Desktop/Phonepe_Pulse_Data_Visualization-main/myfolder/annual report.pdf","rb") as f:
            data = f.read()
        st.download_button("DOWNLOAD REPORT",data,file_name="annual report.pdf")
    with col2:
        st.image(Image.open("/Users/prashanthk/Desktop/Phonepe_Pulse_Data_Visualization-main/myfolder/report.jpeg"),width = 800)
...
if SELECT == "Contact":
    name = "Prashanth R"
    mail = (f'{"Mail :"}  {"prashanthramkumar07@gmail.com"}')
    description = "An Aspiring DATA-SCIENTIST..!"
    social_media = {
        "GITHUB": "https://github.com/07prashu",
        "LINKEDIN": "https://www.linkedin.com/in/prashanth-ramkumar-85aa06125/",
        "INSTAGRAM": "https://instagram.com/chocolateboy_prashu?utm_source=qr&igshid=MzNlNGNkZWQ4Mg%3D%3D"}
    
    col1, col2, col3 = st.columns(3)
    col3.image(Image.open("/Users/prashanthk/Desktop/Phonepe_Pulse_Data_Visualization-main/myfolder/my.jpg"), width=350)
    with col2:
